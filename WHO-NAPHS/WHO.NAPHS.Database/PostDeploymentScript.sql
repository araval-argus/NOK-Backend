...
VALUES
    ...
    ('JEEScoreUrl', 'https://jeereports-uat.who.int/api/JeeReportsApi/NAPHS/JeeMissions/scores'),
    ('JEERecommendationUrl', 'https://jeereports-uat.who.int/api/JeeReportsApi/NAPHS/JeeMissions/recommendations'),
